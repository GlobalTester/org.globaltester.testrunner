        ...
        <fo:flow flow-name="xsl-region-body">
          ...
          <xsl:for-each select="TESTREPORT/TESTCASE">
            ...
            <xsl:if test="TESTCASESTATUS='FAILURE'">
              <fo:block font-size="8pt" line-height="1.5">
                <fo:inline font-weight="bold">Status: </fo:inline>
                Test case failed. For test results please refer the log file generated by GlobalTester in the specified logging folder.
              </fo:block>
            </xsl:if>
            <xsl:if test="TESTCASESTATUS='WARNING'">
              <fo:block font-size="8pt" line-height="1.5">
                <fo:inline font-weight="bold">Status: </fo:inline>
                Test case passed with warnings. For test results please refer the log file generated by GlobalTester in the specified logging folder.
              </fo:block>
            </xsl:if>
			<xsl:if test="TESTCASESTATUS='NOT APPLICABLE'">
              <fo:block font-size="8pt" line-height="1.5">
                <fo:inline font-weight="bold">Status: </fo:inline>
                Test case not applicable. For test results please refer the log file generated by GlobalTester in the specified logging folder.
              </fo:block>
            </xsl:if>
			<xsl:if test="TESTCASESTATUS='SKIPPED'">
			  <fo:block font-size="8pt" line-height="1.5">
				<fo:inline font-weight="bold">Status: </fo:inline>
				Test case skipped. For test results please refer the log file generated by GlobalTester in the specified logging folder.
			  </fo:block>
			</xsl:if>
            <xsl:if test="TESTCASESTATUS='UNDEFINED'">
              <fo:block font-size="8pt" line-height="1.5">
                <fo:inline font-weight="bold">Status: </fo:inline>
                Test case result is undefined. For test results please refer the log file generated by GlobalTester in the specified logging folder.
              </fo:block>
            </xsl:if>
          ...
          GlobalTester is a project of secunet Security Networks AG, Essen, Germany (www.secunet.com).
          </fo:block>
